...
# ============================================
#  清理监控 (Prometheus + Grafana)
#  独立可运行，也可被 clean-all.sh 调度
#
#  用法:
#    bash deploy/clean-prometheus.sh
#
#  说明: 只删除 monitoring/ 目录定义的资源 + prometheus 的 cluster 级资源。
...
echo "=========================================="
echo "  清理监控 (Prometheus + Grafana)"
echo "=========================================="

kubectl delete -f "$ROOT/monitoring/" --ignore-not-found --wait=false 2>/dev/null || true
